#!/usr/bin/python
# LCD_all_functions_robot_demo.py runs through a large sequence of display functions
#     with 3 second gaps between each item
# On a 16×2 LCD, the rows are numbered 1 – 2, while the columns are numbered 0 – 15. 

# command to run this demo:  python3 /home/pi/L298N_flexbot01/LCD_all_functions_robot_demo.py
...
# simple positioning of text on the screen
